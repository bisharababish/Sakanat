...
(function (global) {
  ...
  const dict = {
    ar: {
      ...
      'admin.mfaTitle': 'رمز المصادقة',
      'admin.mfaHint': 'افتح Google Authenticator (أو تطبيق مشابه) وأدخل الرمز من 6 أرقام.',
      'admin.mfaCode': 'رمز المصادقة',
      'admin.mfaContinue': 'متابعة',
      'admin.mfaCancel': 'رجوع لتسجيل الدخول',
      'admin.mfaRequired': 'حساب الأدمن يحتاج المصادقة الثنائية. فعّلها من تطبيق مَطْرَح أولاً.',
      'admin.mfaInvalid': 'رمز المصادقة غير صحيح.',
      'admin.cfgHint':
